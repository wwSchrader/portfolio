...
class AboutPageBody extends Component {
    ...
    render() {
        return (
            <div>
                <Col xs={6} md={4}>
                    <Image src={portraitImg} alt="Portrait of Warren Schrader" responsive rounded/>
                </Col>
                <Col xs={6} md={4}>
                    <Panel>
                        <h1>About Me</h1>
                        <p>
                        I'm a newly minted front end web developer. My previous profession was
                        accounting. However, I couldn't resist the allure of the
